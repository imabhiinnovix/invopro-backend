...
export async function seedChart(payload) {
  ...
  const chartData = [
    ...
    {
      id: payload.stackedBarLineId,
      name: 'Stacked Bar - Line',
      description: 'test stacked bar line description',
      chartType: 'stackedBarLine',
      code: 'stackedBar-line-1',
      fieldConfig: fieldConfig.stackedBarLine,
    },
    {
      id: payload.comboBarLineId,
      name: 'Combo Bar - Line',
      description: 'test combo bar line description',
      chartType: 'comboBarLine',
      code: 'comboBar-line-1',
      fieldConfig: fieldConfig.comboBarLine,
    },
  ];
