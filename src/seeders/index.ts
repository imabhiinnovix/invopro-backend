    ...
    await seedPermissions([
      {
        ...
        resourceCode: 'data_source_case_list_get',
        status: 'active',
        isSuperUser: false,
        organizationId: payload.reportivixOrganizationId,
      },
      {
        name: 'Case List Update',
        method: 'PUT',
        menuName: 'Case List',
        resourceId: 'common/dataSource/update/:dataSourceId',
        dataSourceId: entityDataSourceMapReportivix.case_list.dataSourceId,
        resourceType: 'Data Source',
        resourceCode: 'data_source_case_list_update',
        status: 'active',
        isSuperUser: false,
        organizationId: payload.reportivixOrganizationId,
      },
      {
        ...
        resourceType: 'Data Source',
        resourceCode: 'data_source_action_due_get',
        status: 'active',
        isSuperUser: false,
        organizationId: payload.reportivixOrganizationId,
      },
      {
        name: 'Action Due Update',
        method: 'PUT',
        menuName: 'Action Due',
        resourceId: 'common/dataSource/update/:dataSourceId',
        dataSourceId: entityDataSourceMapReportivix.action_due.dataSourceId,
        resourceType: 'Data Source',
        resourceCode: 'data_source_action_due_update',
        status: 'active',
        isSuperUser: false,
        organizationId: payload.reportivixOrganizationId,
      },
      {
        ...
        resourceType: 'Data Source',
        resourceCode: 'data_source_ip_counsel_get',
        status: 'active',
        isSuperUser: false,
        organizationId: payload.reportivixOrganizationId,
      },
      {
        name: 'IP Counsel Update',
        method: 'PUT',
        menuName: 'IP Counsel',
        resourceId: 'common/dataSource/update/:dataSourceId',
        dataSourceId: entityDataSourceMapReportivix.ip_counsel.dataSourceId,
        resourceType: 'Data Source',
        resourceCode: 'data_source_ip_counsel_update',
        status: 'active',
        isSuperUser: false,
        organizationId: payload.reportivixOrganizationId,
      },
      {
        name: 'Formality Officers Get',
        method: 'GET',
        menuName: 'Formality Officers',
        resourceId: 'common/dataSource/dataSourceId/:dataSourceId',
        dataSourceId: entityDataSourceMapReportivix.formality_officers.dataSourceId,
        resourceType: 'Data Source',
        resourceCode: 'data_source_formality_officers_get',
        status: 'active',
        isSuperUser: false,
        organizationId: payload.reportivixOrganizationId,
      },
      {
        name: 'Formality Officers Update',
        method: 'PUT',
        menuName: 'Formality Officers',
        resourceId: 'common/dataSource/update/:dataSourceId',
        dataSourceId: entityDataSourceMapReportivix.formality_officers.dataSourceId,
        resourceType: 'Data Source',
        resourceCode: 'data_source_formality_officers_update',
        status: 'active',
        isSuperUser: false,
        organizationId: payload.reportivixOrganizationId,
      },
