...
export async function seedDatabase() {
  try {
    ...
    await seedDashboardsForOrganization({
      ...
      widgets: [
        {
          widgetTypeId: payload.numberChartId,
          name: 'Total Action Due',
          dimensions: '',
          groupBy: [],
          aggregation: { type: 'Count', attributeName: 'CaseNumber' },
          position: { x: 0, y: 0, index: 1 },
          dataSourceId: entityDataSourceMapReportivix.case_list.dataSourceId,
        ...
        {
          widgetTypeId: payload.numberChartId,
          name: 'Critical Action Due',
          dimensions: '',
          groupBy: [],
          aggregation: { type: 'Count', attributeName: 'CaseNumber' },
          position: { x: 0, y: 0, index: 2 },
          conditions: [{
    ...
    await seedDashboardsForOrganization({
      ...
      widgets: [
        {
          widgetTypeId: payload.pieChartId,
          name: 'Disclosure by SBU',
          dimensions: 'SBU',
          groupBy: [],
          conditions: [{field: "SBU", operator: "notblank", value: ""}],
          aggregation: { type: 'Count', attributeName: 'DisclosureNumber' },
          position: { x: 0, y: 0, index: 1 },
          dataSourceId: entityDataSourceMapReportivix.disclosure.dataSourceId,
          entityId: entityDataSourceMapReportivix.disclosure.entityId,
          isIncremental: false,
        },
        {
          widgetTypeId: payload.lineChartId,
          name: 'Disclosure by SBU/Attorney',
          dimensions: 'SBU',
          conditions: [{field: "SBU", operator: "notblank", value: ""}],
          groupBy: ["Attorney"],
          aggregation: { type: 'Count', attributeName: 'DisclosureNumber' },
        ...
        widgets: [
          {
            ...
            aggregation: { type: 'Count', attributeName: 'DisclosureNumber' },
            position: { x: 0, y: 0, index: 1 },
            dataSourceId: entityDataSourceMapSabic.disclosure.dataSourceId,
            entityId: entityDataSourceMapSabic.disclosure.entityId,
            isIncremental: false,
          },
          {
            widgetTypeId: payload.lineChartId,
